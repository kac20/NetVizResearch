// This code follows the code provided as an example from the Open Graph Drawing Framework
...
//Returns a pointer to a MultilevelBuilder
...
{
    if (argc != 3) {
        std::cout << "Usage: " << argv[0] << " (0|1|2) filename" << std::endl;
        return 255;
    }
    ...
    string filepath =  "./test-graph-files/test-graph-GML-files/";
